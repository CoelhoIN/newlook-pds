      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="mt-1 text-white/70">
                Gerencie serviços e profissionais do salão
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          <Tabs defaultValue="services" className="space-y-6">
            <TabsList className="border border-[#2A2A2A] bg-[#1A1A1A]">
              <TabsTrigger
                value="services"
                className="text-white data-[state=active]:bg-[#D4A574] data-[state=active]:text-black"
              >
